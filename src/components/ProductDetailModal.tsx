...
import { X, MessageCircle, Clock, ShieldCheck, CheckCircle2, Sparkles, Scissors } from 'lucide-react';
          ...
          <div className="p-6 sm:p-8 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-2 text-xs font-semibold text-charcoal bg-cream-200 p-3 rounded-xl border border-silk-taupe">
                ...
                <span>Estimated Atelier Crafting: <strong>{design.craftingTime}</strong></span>
              </div>

              {/* Fabric Choices Preview */}
              <div className="space-y-2">
                <span className="text-xs font-extrabold uppercase tracking-wider text-charcoal block">Available Fabric Textures:</span>
                <div className="space-y-2">
              ...
              {/* Custom Details List */}
              <div className="space-y-2">
                <span className="text-xs font-extrabold uppercase tracking-wider text-charcoal block">Tailoring Features:</span>
            ...
            <div className="pt-4 border-t border-silk-taupe space-y-3">
              ...
              <p className="text-[10px] text-center text-charcoal/50 uppercase tracking-widest">
                Air_Luxe • Gretel's Plug 2020 • Est 2020
              </p>
            </div>
          </div>
        </div>
